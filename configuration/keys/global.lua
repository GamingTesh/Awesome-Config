...
local globalkeys = awful.util.table.join(
    ...
    -- X screen locker
    awful.key({ altkey, "Control" }, "l", function () os.execute(apps.default.scrlocker) end,
    ...
    awful.key({ modkey }, "a", function () awful.spawn(apps.default.gui_editor) end,
              {description = "run gui editor", group = "launcher"}),
    awful.key({ modkey }, "f", function () awful.spawn(apps.default.file) end,
